...
} from '../../services/riderNotificationService';
import {
  riderWebSocketService,
  OrderAssignment,
} from '../../services/riderWebSocketService';
  ...
  if (loading || !minDelayDone) {
    return (
      <View style={[styles.container, { backgroundColor: colors.background, padding: 16 }]}>
        <SkeletonBox style={{ height: 300, borderRadius: 16, marginBottom: 16 }} />
        <SkeletonCircle style={{ width: 52, height: 52, marginBottom: 16 }} />
        <View style={{ flexDirection: 'row', gap: 12 }}>
          <SkeletonBox style={{ flex: 1, height: 96, borderRadius: 16 }} />
          <SkeletonBox style={{ flex: 1, height: 96, borderRadius: 16 }} />
          <SkeletonBox style={{ flex: 1, height: 96, borderRadius: 16 }} />
        </View>
      </View>
