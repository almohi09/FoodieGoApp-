...
export const RewardsScreen: React.FC = () => {
  ...
  const coupons = __DEV__ ? mockCoupons : [];
  ...
  return (
    ...
    >
      ...
      <View style={styles.couponsSection}>
        ...
        {coupons.map(coupon => (
          <TouchableOpacity activeOpacity={0.7} key={coupon.id} style={styles.couponCard}>
            ...
            <View style={styles.couponRight}>
              <TouchableOpacity activeOpacity={0.7} style={styles.applyButton}>
