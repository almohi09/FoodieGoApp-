...
export const UserRegisterScreen: React.FC = () => {
  ...
  const handleRegister = async () => {
    if (name.trim().length < 2) {
      showToast({ type: 'error', message: 'Please enter a valid name.' });
      return;
    }
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.content}>
          <View style={styles.titleSection}>
            ...
            <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Complete your profile to get started</Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={[styles.inputContainer, { backgroundColor: colors.surface }]}>
              ...
              <View style={styles.phoneDisplay}>
                <Text style={[styles.phoneText, { color: colors.textTertiary }]}>{phone}</Text>
